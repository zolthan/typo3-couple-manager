...
$defaultCropSettings = [
    ...
    'allowedAspectRatios' => [
        ...
        '3:4' => [
            'title' => 'LLL:EXT:couple_manager/Resources/Private/Language/locallang.xlf:3_4',
            'value' => 3 / 4
        ],
        '1:1' => [
...
$GLOBALS['TCA']['pages']['columns']['media']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extrasmall'] = $extrasmallCropSettings;
